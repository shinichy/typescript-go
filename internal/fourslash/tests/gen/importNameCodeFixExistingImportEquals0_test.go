...
declare module "ambient-module" {
   ...
   export var v1;
	...
	f.VerifyImportFixAtPosition(t, []string{"import ns = require(\"ambient-module\");\nvar x = ns.v1 + 5;", "import { v1 } from \"ambient-module\";\nimport ns = require(\"ambient-module\");\nvar x = v1 + 5;"}, nil /*errorCode*/, nil /*preferences*/)
}
