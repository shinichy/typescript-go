...
d/*2*//*2a*//*2b*//*2c*/`
	...
	f.GoToMarker(t, "0")
	f.VerifyImportFixAtPosition(t, []string{"import { a, A, B, C } from \"./exports1\";\na;\nb;", "import { A, b, B, C } from \"./exports1\";\na;\nb;"}, nil /*errorCode*/, nil /*preferences*/)
	f.GoToMarker(t, "0a")
	f.VerifyImportFixAtPosition(t, []string{"import { a, A, B, C } from \"./exports1\";\na;\nb;", "import { A, b, B, C } from \"./exports1\";\na;\nb;"}, nil /*errorCode*/, nil /*preferences*/)
	f.GoToMarker(t, "1")
	f.VerifyImportFixAtPosition(t, []string{"import { a, A, B, C, type Y, type Z } from \"./exports1\";\na;\nb;", "import { A, b, B, C, type Y, type Z } from \"./exports1\";\na;\nb;"}, nil /*errorCode*/, nil /*preferences*/)
	f.GoToMarker(t, "1a")
	f.VerifyImportFixAtPosition(t, []string{"import { a, A, B, C, type Y, type Z } from \"./exports1\";\na;\nb;", "import { A, b, B, C, type Y, type Z } from \"./exports1\";\na;\nb;"}, nil /*errorCode*/, nil /*preferences*/)
	f.GoToMarker(t, "1b")
	f.VerifyImportFixAtPosition(t, []string{"import { a, A, B, C, type Y, type Z } from \"./exports1\";\na;\nb;", "import { A, b, B, C, type Y, type Z } from \"./exports1\";\na;\nb;"}, nil /*errorCode*/, nil /*preferences*/)
	...
	f.VerifyImportFixAtPosition(t, []string{"import { a, A, B, C, type Y, type Z } from \"./exports1\";\na;\nb;", "import { A, b, B, C, type Y, type Z } from \"./exports1\";\na;\nb;"}, nil /*errorCode*/, nil /*preferences*/)
	f.GoToMarker(t, "2")
	f.VerifyImportFixAtPosition(t, []string{"import { A, a, B, b, type Y, type Z } from \"./exports1\";\nimport { d, E } from \"./exports2\";\nd"}, nil /*errorCode*/, nil /*preferences*/)
	f.GoToMarker(t, "2a")
