...
export const dep2 = 0;`
	...
	f.GoToMarker(t, "1")
	f.VerifyImportFixAtPosition(t, []string{"import { dep1 } from \"dep\";\r\n\r\ndep1;"}, nil /*errorCode*/, nil /*preferences*/)
	f.GoToMarker(t, "2")
	f.VerifyImportFixAtPosition(t, []string{"import { dep2 } from \"dep/dist/sub/folder\";\r\n\r\ndep2;"}, nil /*errorCode*/, nil /*preferences*/)
}
