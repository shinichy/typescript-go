...
readFile/**/`
	...
	f.GoToMarker(t, "")
	f.VerifyImportFixAtPosition(t, []string{}, nil /*errorCode*/, nil /*preferences*/)
	f.GoToBOF(t)
	f.InsertLine(t, "import { writeFile } from \"node:fs\";")
	f.GoToMarker(t, "")
	f.VerifyImportFixAtPosition(t, []string{"import { readFile, writeFile } from \"node:fs\";\nreadFile"}, nil /*errorCode*/, nil /*preferences*/)
}
