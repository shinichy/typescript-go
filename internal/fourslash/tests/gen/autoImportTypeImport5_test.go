...
const bar: y;`
	...
	f.GoToMarker(t, "0")
	f.VerifyImportFixAtPosition(t, []string{"import { type x, type X, type Y, type Z } from \"./exports1\";\nconst foo: x;\nconst bar: y;", "import { type X, type y, type Y, type Z } from \"./exports1\";\nconst foo: x;\nconst bar: y;"}, nil /*errorCode*/, nil /*preferences*/)
	f.VerifyImportFixAtPosition(t, []string{"import { type x, type X, type Y, type Z } from \"./exports1\";\nconst foo: x;\nconst bar: y;", "import { type X, type y, type Y, type Z } from \"./exports1\";\nconst foo: x;\nconst bar: y;"}, nil /*errorCode*/, nil /*preferences*/)
	f.VerifyImportFixAtPosition(t, []string{"import { type x, type X, type Y, type Z } from \"./exports1\";\nconst foo: x;\nconst bar: y;", "import { type X, type y, type Y, type Z } from \"./exports1\";\nconst foo: x;\nconst bar: y;"}, nil /*errorCode*/, nil /*preferences*/)
	f.VerifyImportFixAtPosition(t, []string{"import { type x, type X, type Y, type Z } from \"./exports1\";\nconst foo: x;\nconst bar: y;", "import { type X, type y, type Y, type Z } from \"./exports1\";\nconst foo: x;\nconst bar: y;"}, nil /*errorCode*/, nil /*preferences*/)
	f.VerifyImportFixAtPosition(t, []string{"import { type x, type X, type Y, type Z } from \"./exports1\";\nconst foo: x;\nconst bar: y;", "import { type X, type y, type Y, type Z } from \"./exports1\";\nconst foo: x;\nconst bar: y;"}, nil /*errorCode*/, nil /*preferences*/)
	f.VerifyImportFixAtPosition(t, []string{"import { type x, type X, type Y, type Z } from \"./exports1\";\nconst foo: x;\nconst bar: y;", "import { type X, type y, type Y, type Z } from \"./exports1\";\nconst foo: x;\nconst bar: y;"}, nil /*errorCode*/, nil /*preferences*/)
	f.GoToMarker(t, "1")
	f.VerifyImportFixAtPosition(t, []string{"import { A, B, type x, type X, type Y, type Z } from \"./exports1\";\nconst foo: x;\nconst bar: y;", "import { A, B, type X, type y, type Y, type Z } from \"./exports1\";\nconst foo: x;\nconst bar: y;"}, nil /*errorCode*/, nil /*preferences*/)
	f.VerifyImportFixAtPosition(t, []string{"import { A, B, type x, type X, type Y, type Z } from \"./exports1\";\nconst foo: x;\nconst bar: y;", "import { A, B, type X, type y, type Y, type Z } from \"./exports1\";\nconst foo: x;\nconst bar: y;"}, nil /*errorCode*/, nil /*preferences*/)
}
