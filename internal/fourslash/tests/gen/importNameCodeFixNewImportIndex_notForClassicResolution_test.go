...
[|bar;|]`
	...
	f.GoToFile(t, "/b.ts")
	f.VerifyImportFixAtPosition(t, []string{"import { foo } from \"./a/index\";\n\nfoo;"}, nil /*errorCode*/, nil /*preferences*/)
	f.GoToFile(t, "/c.ts")
	f.VerifyImportFixAtPosition(t, []string{"import { bar } from \"./node_modules/x/index\";\n\nbar;"}, nil /*errorCode*/, nil /*preferences*/)
}
